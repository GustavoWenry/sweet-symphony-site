      ...
      <div className="container-custom relative z-10">
        ...
        >
          <motion.span
            ...
            className="inline-block bg-white/20 text-white/90 text-sm font-medium px-4 py-1.5 rounded-full mb-6"
          >
          ...
          >
            Pronto para adoçar seu
            <br />
            <span className="text-white/90">momento especial?</span>
          </motion.h2>
          ...
          >
            Entre em contato agora pelo WhatsApp e receba seu orçamento 
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center gap-3 bg-card text-foreground font-semibold text-lg px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all"
            >
              <svg 
                viewBox="0 0 24 24" 
