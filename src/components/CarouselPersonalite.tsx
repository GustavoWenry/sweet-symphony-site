...
// Import sweet images
import personaliteBolodoGuido from '@/assets/sweets/personalite-bolodogui.png';
import personalitePlacaOne from '@/assets/sweets/personalite-placaone.png';
import personaliteLis from '@/assets/sweets/personalite-lis.png';
import personalitePlatwo from '@/assets/sweets/personalite-platwo.png';
const sweets = [

  { id: 1, image: personaliteBolodoGuido, title: 'Bolo Personalizado', description: 'Aniversario Infantil' },
  { id: 2, image: personalitePlacaOne, title: 'Placa Comestível', description: 'Decoração Personalizada' },
  { id: 3, image: personaliteLis, title: 'Enfeite de Lis', description: 'Letreiro Personalizado' },
  { id: 4, image: personalitePlatwo, title: 'Plaquinha Comestível', description: 'Placa Personalizada' },
...
const WHATSAPP_VER_DOCES = "https://wa.me/5515981283406?text=Olá,%20vim%20pelo%20site%20e%20gostaria%20de%20fazer%20um%20orçamento%20para%20uma%20celebração%20.";

const CarouselPersonalite = () => {
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Enfeites comestiveis personalisados que encantam os olhos e conquistam o paladar. 
...
export default CarouselPersonalite;
